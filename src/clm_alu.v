...
module clm_alu (
    ...
    assign shifter_result = shift_direction ? shifter_stage_four : {shifter_stage_four[0], shifter_stage_four[1], shifter_stage_four[2], 
    shifter_stage_four[3], shifter_stage_four[4], shifter_stage_four[5], shifter_stage_four[6], shifter_stage_four[7]};
